...
@section('whatcanyoudo_menu_active')
    mm-active
@endsection
...
<div class="col-xl-10 m-auto">
    <div class="card">
        <div class="card-body">
            ...
            <form class="form-group" method="POST" action="{{ route('whatcanyoudo.store') }}" enctype="multipart/form-data">
            @csrf
                    <div class="py-3">
                    ...
                    <div class="py-3">
                        <img src="{{ asset('uploads/whatcanyoudo') }}/{{ $banner->image}}" alt="not found" width="200">
                    </div>
                    <div class="py-3">
